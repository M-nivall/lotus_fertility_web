...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update = "UPDATE pharmacist_assignments SET medicine_status = 'Approved' WHERE id='$id'";
    ...
    if (mysqli_query($con, $update)) {
        ...
        foreach ($tools as $tool) {
            ...
            $decrementQuery = "UPDATE medicine SET quantity = quantity - 1 WHERE med_name = '$tool'";
        ...
        $response['status'] = 1;
        $response['message'] = 'Approved Succefully';
