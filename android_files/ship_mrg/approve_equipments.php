...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update = "UPDATE medical_test SET equipment_status = 'Approved' WHERE test_id='$id'";
    ...
    if (mysqli_query($con, $update)) {
        ...
        foreach ($tools as $tool) {
            ...
            $decrementQuery = "UPDATE equipments SET quantity = quantity - 1 WHERE equipment_name = '$tool'";
        ...
        $response['status'] = 1;
        $response['message'] = 'Equipments Request Approved Succefully';
