...
$select = "SELECT s.schedule_id,s.parent_id,s.surrogate_id,s.partner_name,s.schedule_date,s.booking_date,
    s.service_fee,s.surrogate_fee,s.total_fee,s.payment_code,s.schedule_type,
    ...
    surrogate.email AS surrogate_email
        ...
        WHERE s.schedule_status='4' ORDER BY s.schedule_id DESC";
  ...
  if(mysqli_num_rows($query)>0){
      ...
      while ($row=mysqli_fetch_array($query)){
          ...
          $temp['payment_status'] = "Pending approval";
