...
//creating a query
$select = "SELECT s.surrogate_id,s.height,s.weight,s.blood_type,s.medication,s.marital_status,s.education,
        s.num_children,s.more_details,s.id_image,s.medical_image,s.photo_image,s.surrogate_status,c.full_name,
        ...
        WHERE c.user='Surrogate Mother' AND s.surrogate_status = 'Pending approval'
        ORDER BY s.id DESC";
  ...
  if(mysqli_num_rows($query)>0){
      ...
      $results['message']="Surrogate Mothers";
