              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Payment Details </h4>
                                            ...
                                            <?php
                    $select="SELECT * FROM clients c INNER JOIN schedule s on c.client_id = s.surrogate_id
                       RIGHT JOIN service_payment p on s.schedule_id = p.order_id WHERE  s.schedule_id=".$_GET['get'];
